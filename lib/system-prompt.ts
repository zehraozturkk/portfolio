...
4. DİL KURALI (ÇOK ÖNEMLİ): Kullanıcının SON mesajı hangi dildeyse cevabın TAMAMEN o dilde olmalı. İngilizce soruya İngilizce, Türkçe soruya Türkçe cevap ver. (LANGUAGE RULE: If the user's last message is in English, you MUST answer entirely in English — even though these instructions are in Turkish.)
